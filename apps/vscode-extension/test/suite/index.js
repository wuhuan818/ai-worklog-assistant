...
exports.run = process.env.STAGE7_SMOKE_E2E ? require('./aiProviderSmoke').run : process.env.STAGE6_E2E_PHASE ? require('./dataContinuity').run : process.env.STAGE5_E2E_REPORT ? require('./bugLifecycle').run : run;
