...
export const qwenRegionOptions: ReadonlyArray<{ label: string; region: QwenRegion; baseUrl: string; requiresWorkspaceId: boolean }> = [
  { label: '中国北京', region: 'beijing', baseUrl: 'https://dashscope.aliyuncs.com/compatible-mode/v1', requiresWorkspaceId: false },
  { label: '新加坡', region: 'singapore', baseUrl: 'https://dashscope-intl.aliyuncs.com/compatible-mode/v1', requiresWorkspaceId: false },
  { label: '日本东京', region: 'tokyo', baseUrl: 'https://dashscope-intl.aliyuncs.com/compatible-mode/v1', requiresWorkspaceId: false },
  { label: '德国法兰克福', region: 'frankfurt', baseUrl: 'https://dashscope-intl.aliyuncs.com/compatible-mode/v1', requiresWorkspaceId: false },
  { label: '美国弗吉尼亚', region: 'virginia', baseUrl: 'https://dashscope-intl.aliyuncs.com/compatible-mode/v1', requiresWorkspaceId: false },
